 ...
 * Use the {@link fragment_cody_lib10up#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_cody_lib10up extends Fragment {
     ...
     * @return A new instance of fragment fragment_cody_lib10up.
     */
    // TODO: Rename and change types and number of parameters
    public static fragment_cody_lib10up newInstance(String param1, String param2) {
        fragment_cody_lib10up fragment = new fragment_cody_lib10up();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cody_lib_10up, container, false);

        //SharedPreference 내에 HashSet<String> 타입으로 존재하는 북마크 받아옥
        bookMarkSet = PreferenceManager.getStringSet(getContext(),"bookMark");

        int [] myLibCody = {R.id.book_lib10_cody1,R.id.book_lib10_cody2, R.id.book_lib10_cody3, R.id.book_lib10_cody4, R.id.book_lib10_cody5, R.id.book_lib10_cody6, R.id.book_lib10_cody7, R.id.book_lib10_cody8, R.id.book_lib10_cody9};
        int [] myLibBookMark = {R.id.bookmark_lib10_cody1,R.id.bookmark_lib10_cody2,R.id.bookmark_lib10_cody3,R.id.bookmark_lib10_cody4,R.id.bookmark_lib10_cody5,R.id.bookmark_lib10_cody6,R.id.bookmark_lib10_cody7,R.id.bookmark_lib10_cody8,R.id.bookmark_lib10_cody9};
        int [] codyLibArr = {R.drawable.cody1, R.drawable.cody4, R.drawable.cody20};
        int curIdx = 0;
