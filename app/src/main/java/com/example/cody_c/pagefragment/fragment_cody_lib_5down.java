 ...
 * Use the {@link fragment_cody_lib_5down#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_cody_lib_5down extends Fragment {
    ...
    public fragment_cody_lib_5down() {
     ...
     * @return A new instance of fragment fragment_cody_lib_5down.
     */
    // TODO: Rename and change types and number of parameters
    public static fragment_cody_lib_5down newInstance(String param1, String param2) {
        fragment_cody_lib_5down fragment = new fragment_cody_lib_5down();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView =  inflater.inflate(R.layout.fragment_cody_lib_5down, container, false);
        ...
        int [] myLibCody = {R.id.book_lib5_cody1,R.id.book_lib5_cody2, R.id.book_lib5_cody3, R.id.book_lib5_cody4, R.id.book_lib5_cody5, R.id.book_lib5_cody6, R.id.book_lib5_cody7, R.id.book_lib5_cody8, R.id.book_lib5_cody9};
        int [] myLibBookMark = {R.id.bookmark_lib5_cody1,R.id.bookmark_lib5_cody2,R.id.bookmark_lib5_cody3,R.id.bookmark_lib5_cody4,R.id.bookmark_lib5_cody5,R.id.bookmark_lib5_cody6,R.id.bookmark_lib5_cody7,R.id.bookmark_lib5_cody8,R.id.bookmark_lib5_cody9};
        int [] codyLibArr = {R.drawable.cody22};
        int curIdx = 0;
