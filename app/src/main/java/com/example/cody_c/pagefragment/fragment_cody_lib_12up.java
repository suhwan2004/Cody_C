 ...
 * Use the {@link fragment_cody_lib_12up#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_cody_lib_12up extends Fragment {
     ...
     * @return A new instance of fragment fragment_cody_lib_12up.
     */
    // TODO: Rename and change types and number of parameters
    public static fragment_cody_lib_12up newInstance(String param1, String param2) {
        fragment_cody_lib_12up fragment = new fragment_cody_lib_12up();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cody_lib_12up, container, false);

        //SharedPreference 내에 HashSet<String> 타입으로 존재하는 북마크 받아옥
        bookMarkSet = PreferenceManager.getStringSet(getContext(),"bookMark");

        int [] myLibCody = {R.id.book_lib12_cody1,R.id.book_lib12_cody2, R.id.book_lib12_cody3, R.id.book_lib12_cody4, R.id.book_lib12_cody5, R.id.book_lib12_cody6, R.id.book_lib12_cody7, R.id.book_lib12_cody8, R.id.book_lib12_cody9};
        int [] myLibBookMark = {R.id.bookmark_lib12_cody1,R.id.bookmark_lib12_cody2,R.id.bookmark_lib12_cody3,R.id.bookmark_lib12_cody4,R.id.bookmark_lib12_cody5,R.id.bookmark_lib12_cody6,R.id.bookmark_lib12_cody7,R.id.bookmark_lib12_cody8,R.id.bookmark_lib12_cody9};
        int [] codyLibArr = {R.drawable.cody2, R.drawable.cody14};
        int curIdx = 0;
