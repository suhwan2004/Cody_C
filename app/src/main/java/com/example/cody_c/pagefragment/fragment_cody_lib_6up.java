 ...
 * Use the {@link fragment_cody_lib_6up#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragment_cody_lib_6up extends Fragment {
     ...
     * @return A new instance of fragment fragment_cody_lib_6up.
     */
    // TODO: Rename and change types and number of parameters
    public static fragment_cody_lib_6up newInstance(String param1, String param2) {
        fragment_cody_lib_6up fragment = new fragment_cody_lib_6up();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView =  inflater.inflate(R.layout.fragment_cody_lib_6up, container, false);
        ...
        int [] myLibCody = {R.id.book_lib6_cody1,R.id.book_lib6_cody2, R.id.book_lib6_cody3, R.id.book_lib6_cody4, R.id.book_lib5_cody5, R.id.book_lib6_cody6, R.id.book_lib6_cody7, R.id.book_lib6_cody8, R.id.book_lib6_cody9};
        int [] myLibBookMark = {R.id.bookmark_lib6_cody1,R.id.bookmark_lib6_cody2,R.id.bookmark_lib6_cody3,R.id.bookmark_lib6_cody4,R.id.bookmark_lib6_cody5,R.id.bookmark_lib6_cody6,R.id.bookmark_lib6_cody7,R.id.bookmark_lib6_cody8,R.id.bookmark_lib6_cody9};
        int [] codyLibArr = {R.drawable.cody19, R.drawable.cody21};
        int curIdx = 0;
