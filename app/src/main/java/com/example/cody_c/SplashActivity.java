...
import com.example.cody_c.util.AddressParsingUtil;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void initSharedPreference(){
        ...
        if(PreferenceManager.getFloat(this, "LATITUDE")==-1.0
         ...
         else { latitude = 37.5172f; longitude = 127.0473f; }
        ...
        if(getCurrentAddress(latitude, longitude) == null) {
            address = getCurrentAddress(Math.round(latitude*100)/100.0 ,Math.round(longitude*100)/100.0);
            PreferenceManager.setFloat(this,"LATITUDE",(float)latitude);
            PreferenceManager.setFloat(this,"LONGITUDE",(float)longitude);
        }
        else {
            address = getCurrentAddress(latitude ,longitude);
            PreferenceManager.setFloat(this,"LATITUDE",(float)(Math.round(latitude*100)/100.0));
            PreferenceManager.setFloat(this,"LONGITUDE",(float)(Math.round(longitude*100)/100.0));
        }
    ...
    public String getCurrentAddress( double latitude, double longitude) {
        ...
        try {
            ...
            return null;
        } catch (IllegalArgumentException illegalArgumentExceptio) {
            return null;
        }
